...
if __name__ == "__main__":
    try:
        ...
        initialize_portfolio(setup_client, starting_cash=100000, symbol=symbol, starting_market_value=100000, strategy_names=[strategy_name], initialization_price=initialization_price)
        init_consumer.close()
